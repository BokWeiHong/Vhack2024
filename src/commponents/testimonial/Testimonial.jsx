    ...
    return (
        <div className="testimonial p-8">
            ...
            <p
                ...
                Real People, Real Results: How Our Clients Achieve Their Investment Goals
            </p>
            </div>
            ...
            <div class="mb-12 md:mb-0">
                ...
                <h5 class="mb-4 text-xl font-semibold">Sarah K., Teacher</h5>
                ...
                Before investing, I felt lost. Now, with Bee4Invest's guidance, I'm building a secure future. My returns are impressive!
                </p>
            ...
            <div class="mb-12 md:mb-0">
                ...
                Investing used to be scary. Bee4Invest made it clear and simple. Now, my money's working hard for me, stress-free.
                </p>
                <ul class="mb-0 flex items-center justify-center">
                <li>
                    <svg
            ...
            <div class="mb-0">
                ...
                Wish I'd started investing sooner! Bee4Invest empowered me to take control and my portfolio's growing steadily.
                </p>
                <ul class="mb-0 flex items-center justify-center">
                <li>
                    <svg
